<?php
// teacher/class_attendance_debug.php
session_start();
...
// Handle attendance submission with detailed error logging
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_attendance'])) {
    $attendance_date = $_POST['attendance_date'];
    $class_id = $_POST['class_id'];
    
    // Debug: Log form submission
    error_log("ATTENDANCE DEBUG: Form submitted - Date: $attendance_date, Class: $class_id, Teacher: $teacher_id, School: $current_school_id");
    ...
    try {
        ...
        foreach ($_POST['attendance'] as $student_id => $status) {
            ...
            // Debug: Log each student record
            error_log("ATTENDANCE DEBUG: Processing student $student_id - Status: $status, Remarks: $remarks");
            ...
            if ($existing_record) {
                ...
                $update_count++;
                error_log("ATTENDANCE DEBUG: Updating existing record for student $student_id");
            } else {
                // Insert new record
                ...
                $insert_count++;
                error_log("ATTENDANCE DEBUG: Inserting new record for student $student_id");
            }
            ...
            if (!$result) {
                throw new Exception("Failed to save attendance for student $student_id");
            }
        }
        
        $pdo->commit();
        error_log("ATTENDANCE DEBUG: Transaction committed successfully - $insert_count inserts, $update_count updates");
        $_SESSION['success'] = "Attendance submitted successfully! ($insert_count new, $update_count updated)";
        header("Location: class_attendance_debug.php?date=$attendance_date&class_id=$class_id");
        exit();
        
    } catch(PDOException $e) {
        $pdo->rollBack();
        error_log("ATTENDANCE DEBUG: PDO Exception - " . $e->getMessage());
        error_log("ATTENDANCE DEBUG: SQL State - " . $e->getCode());
        error_log("ATTENDANCE DEBUG: Error Info - " . print_r($e->errorInfo, true));
        $_SESSION['error'] = "Database error: " . $e->getMessage();
    } catch(Exception $e) {
        $pdo->rollBack();
        error_log("ATTENDANCE DEBUG: General Exception - " . $e->getMessage());
...
<body>
    ...
    <div class="debug-panel" id="debugPanel">
        <div class="debug-header">
            <span>Debug Information (Click to toggle)</span>
            <button class="toggle-debug" onclick="toggleDebug()">Toggle</button>
        </div>
        <div class="debug-content" id="debugContent">
            Debug panel is active. Check browser console for detailed logs.
        </div>
    </div>
        ...
        <div class="modern-card animate-fade-in-up">
            <div class="card-header-modern">
                <h2 class="card-title-modern">
                    ...
                    Class Attendance Management (Debug Mode)
                </h2>
                <p class="card-subtitle-modern">
                    Debug version with detailed logging. Check browser console for error details.
                </p>
            </div>
        </div>
        ...
        <div class="controls-modern animate-fade-in-up">
            <div class="form-row-modern">
                <div class="form-group-modern">
                    ...
                    <input type="date" class="form-input-modern" name="date" value="<?php echo $selected_date; ?>" form="attendanceForm">
                </div>
                <div class="form-group-modern">
                    <label class="form-label-modern">Select Class</label>
                    <select class="form-input-modern" name="class_id" form="attendanceForm">
                ...
                <div class="form-group-modern">
                    ...
                    <button type="submit" class="btn-modern-primary" form="attendanceForm">
    ...
    <script>
        ...
        document.querySelectorAll('.status-btn-modern').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Debug logging
                console.log('Status updated for student ' + studentId + ': ' + status);
            });
        });
        ...
        function submitAttendance() {
            ...
            console.log('Form submission debug:', formObject);
