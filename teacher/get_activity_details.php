...
try {
    ...
    if (!$activity) {
        echo '<div class="alert alert-warning">Activity not found or you don\'t have permission to view it</div>';
        exit;
    }
                                            ...
                                            <div class="card-body text-center">
                                                <?php if ($attachment['file_type'] == 'image'): ?>
                                                    <img src="<?= htmlspecialchars($attachment['file_path']) ?>" 
                                                         ...
                                                         onclick="openImageModal('<?= htmlspecialchars($attachment['file_path']) ?>')">
    ...
    echo '<div class="alert alert-danger p-3 m-3">Database error: ' . htmlspecialchars($e->getMessage()) . '</div>';
    exit;
}
